...
public class TerminalWebSocket {
    private static ClientDetailsMapper detailMapper;

    @Resource
    public void setDetailMapper(ClientDetailsMapper detailMapper) {
    ...
    public void onOpen(Session session,
        ...
        ClientDetails detail = detailMapper.selectById(clientId);
